        ...
        <form action="{{ route('produtos.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="form-group col-3">
                    ...
                    <input type="number" required min="0" value="0" class="form-control" name="estoque"
                    id="estoque">
                </div>
                <div class="form-group col-3">
                    <label for="preco">Preço</label>
                    <input type="number" required min="0" value="0.00" step=".01" class="form-control" name="preco"
                    id="preco" placeholder="Produto">
                </div>
                <div class="form-group col-3">
                    <label for="categoriaId">Categoria</label>
                    <select class="form-control" name="categoriaId" name="categoriaId" aria-label=".form-select-lg example">
                    @foreach($cats as $cat)
