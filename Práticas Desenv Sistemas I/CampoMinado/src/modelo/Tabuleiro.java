...
public class Tabuleiro implements CampoObservador {
	...
	public void adicionarBotaoCadaCampo(Consumer<Campo> funcao) {
		campos.forEach(funcao);
	}
	
	public void adicionarObservadorEventos(Consumer<ResultadoEvento> obs) {
